  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        ...
        <Spline className="scale-110 md:scale-125 lg:scale-150 rounded-full" scene="https://prod.spline.design/h6NwitpQeeC3G7d1/scene.splinecode" />
        ...
        <div className="absolute left-0 top-0 z-40 size-full lg:px-20">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <p className="mb-5 max-w-64 font-robert-regular text-black text-xl">
              Your AI-Powered Mental Health Companion <br /> Support, Awareness,
              and Growth
            </p>
